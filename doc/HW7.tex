...
\begin{center}
	\begin{soln}
		\href[pdfnewwindow=true]{https://github.com/MondoGao/uwm-cs760-hw7}{https://github.com/MondoGao/uwm-cs760-hw7}
	\end{soln}
\end{center}
...
\begin{enumerate}
	...
	\item  python run.py -s vi -d FrozenLake-v0 -e 500 -g 0.9
	      ...
	      \begin{soln}
		      Converges to a reward of \verb|2.1761| in \verb|252| episodes.
	      \end{soln}
